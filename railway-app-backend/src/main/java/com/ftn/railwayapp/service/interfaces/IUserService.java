...
public interface IUserService {
    ...
    UserResponse update(Long id, String fullName, Gender gender, String city, String street, String streetNumber, String zipcode) throws EntityNotFoundException;

    boolean changePassword(Long id, String oldPassword, String newPassword, String confirmPassword) throws EntityNotFoundException, PasswordsDoNotMatchException, OperationCannotBeCompletedException;
}
